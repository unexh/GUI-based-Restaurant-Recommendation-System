...
backGround2ImageLink= r'C:\Users\Unex H\Desktop\Ai Project\GUI-based-Restaurant-Recommendation-System\images\Sitting-near-table-darkened.jpg'
backButtonImageLink =r'C:\Users\Unex H\Desktop\Ai Project\GUI-based-Restaurant-Recommendation-System\images\icons8-back-50.png'
...
class RestaurantData:
        ...
        def ReturnLocalityName(self,currentCity):#dffunc
        ...
        def ReturnDF(self):
            ...
            data_sample=[]
            #print(self.RestaurantRecommendFunc('Connaught Place','Pizza Hut'))
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        print(self.Data.ReturnTopFiveRestaurantName())
    ...
    def TopRestaurantNamesAction(self,BNum):
        for i in range(5):
            if(BNum == i): #'City','Locality','Restaurant Name'
